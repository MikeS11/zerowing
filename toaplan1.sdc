## Generated SDC file "toaplan1.sdc"
...
create_generated_clock -name {SDRAM_CLK} -source [get_pins -compatibility_mode {*|pll|pll_inst|altera_pll_i|*[1].*|divclk}] -master_clock {emu|pll|pll_inst|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk} [get_ports {SDRAM_CLK}] 
